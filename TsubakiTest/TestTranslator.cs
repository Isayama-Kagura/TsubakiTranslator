...
namespace TsubakiTest
{
    public class Tests
    {
        string translateWithTranslator(ITranslator translator,int index, string param1, string param2, string content)
        {
            translator.TranslatorInit(index, param1, param2);
